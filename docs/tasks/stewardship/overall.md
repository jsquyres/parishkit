...
background/source pipeline have been implemented. ADM-02's complete initial
setup workflow is the active package; remaining preparation and integrated
acceptance work are tracked in that guide. No Phase 3 work or next PR merge is
authorized yet.
