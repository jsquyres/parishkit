...
def test_terminal_status_is_passive_and_never_resends(page, component_origin, unknown):
    ...
    page.route("**/admin/setup/mail-test/status", respond)
    page.goto(component_origin + "/setup-mail-test")
